  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        pride: "0 0 40px rgba(255,79,216,0.3), 0 0 80px rgba(139,92,246,0.2)",
        gold: "0 0 30px rgba(245,200,76,0.35), 0 0 60px rgba(245,200,76,0.15)",
        silver: "0 0 30px rgba(203,213,225,0.35), 0 0 60px rgba(203,213,225,0.15)",
        bronze: "0 0 30px rgba(217,119,6,0.35), 0 0 60px rgba(217,119,6,0.15)",
      },
      keyframes: {
